...
{
    /// <summary>
    /// Comando para consultar las facturas pagadas de una compania
    /// </summary>
    public class ComandoConsultarFacturasPagadasCompania : Comando<List<Entidad>>
    {
        /// <summary>
        /// Constructor del comando
        /// </summary>
        /// <param name="parametro">Compania a buscar facturas pagadas</param>
        public ComandoConsultarFacturasPagadasCompania(Entidad parametro)
        {
            LaEntidad = parametro;
        }
        ...
        public override List<Entidad> Ejecutar()
        {
            try
            {
                ...
                return daoFactura.ContactFacturasPagadasCompania(LaEntidad);
            }
