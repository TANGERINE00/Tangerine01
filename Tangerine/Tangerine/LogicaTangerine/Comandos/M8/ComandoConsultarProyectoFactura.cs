...
{
    /// <summary>
    /// Comando para consultar el proyecto de una factura
    /// </summary>
    public class ComandoConsultarProyectoFactura : Comando<Entidad>
    {
        /// <summary>
        /// Constructor del comando
        /// </summary>
        /// <param name="parametro">Factura a buscar su proyecto</param>
        public ComandoConsultarProyectoFactura(Entidad parametro)
        {
            LaEntidad = parametro;
        }
        ...
        public override Entidad Ejecutar()
        {
            try
            {
                ...
                return daoFactura.ContactProyectoFactura(this.LaEntidad);
            }
