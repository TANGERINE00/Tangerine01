...
namespace LogicaTangerine.Comandos.M8
{
    ...
    /// </summary>
    public class ComandoAnularFactura : Comando<bool>
    {
        /// <summary>
        /// Constructor del comando
        /// </summary>
        /// <param name="parametro">Factura a anular</param>
        public ComandoAnularFactura(Entidad parametro)
        {
            LaEntidad = parametro;
        }
        ...
        public override bool Ejecutar()
        {
            try
            {
                ...
                bool respuesta = daoFactura.AnnularFactura(this.LaEntidad);
                return respuesta;
            }
