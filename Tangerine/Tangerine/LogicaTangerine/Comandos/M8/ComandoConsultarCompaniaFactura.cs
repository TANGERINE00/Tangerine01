...
{
    /// <summary>
    /// Comando para consultar la compania de una factura
    /// </summary>
    public class ComandoConsultarCompaniaFactura : Comando<Entidad>
    {
        /// <summary>
        /// Constructor del comando
        /// </summary>
        /// <param name="parametro">Factura a buscar su compania</param>
        public ComandoConsultarCompaniaFactura(Entidad parametro)
        {
            LaEntidad = parametro;
        }
        ...
        public override Entidad Ejecutar()
        {
            try
            {
                ...
                return daoFactura.ConsultCompany(this.LaEntidad);
            }
