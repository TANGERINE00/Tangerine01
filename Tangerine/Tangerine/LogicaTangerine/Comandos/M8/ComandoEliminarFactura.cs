...
{
    /// <summary>
    /// Comando para eliminar una factura
    /// </summary>
    public class ComandoEliminarFactura : Comando<bool>
    {
        /// <summary>
        /// Constructor del comando
        /// </summary>
        /// <param name="parametro">Factura a eliminar</param>
        public ComandoEliminarFactura(Entidad parametro)
        {
            LaEntidad = parametro;
        }
        ...
        public override bool Ejecutar()
        {
            try
            {
                ...
                bool respuesta = daoFactura.DeleteFactura(this.LaEntidad);
                return respuesta;
            }
