                ...
                <form role="form" name="agregar_contacto" id="agregar_contacto" method="post"   runat="server">
			        <div id="id_otro" runat="server" class="form-group">
				        <div class="icon-addon addon-lg" style="margin-left: 10px;">
                            ...
                            <input runat="server" type="text" pattern="([a-zA-Z0-9._-!]+@[a-z0-9._-]+.[a-z]){6,50}" class="form-control" id="correo" name="correo" required oninvalid="setCustomValidity('Campo obligatorio, debe tener un formato de correo. Ej: micorreo@yahoo.com, otrocorreo@gmail.com. Máximo 50 caracteres')" oninput="setCustomValidity('')">
                        </div>	
                    </div>
