            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-md-6 col-lg-6">
                    ...
                    <div class="form-group ">
                        ...
                        <input type="text" runat="server" id="FirstName" class="form-control" maxlength="20" 
                            placeholder="Introduzca primer nombre" oninput="setCustomValidity('')" pattern="^[a-zA-Záéíóúñ\s]*$" 
                            required oninvalid="setCustomValidity('Campo inválido o vacío')">
                    </div>
                    <%--<Segundo Nombre>--%> 
                    <div class="form-group ">
                        <label for="SecondName">Segundo Nombre</label>
                        <input type="text" runat="server" id="SecondNamee" class="form-control" maxlength="20" placeholder="Segundo Nombre">
                    </div>
                    <%--<Primer Apellido>--%> 
                    <div class="form-group ">
                        <label for="FirstLastName">Primer Apellido</label> <label for="Requerido" style="color: red;">*</label>
                        <input type="text" runat="server" id="FirstLastName" class="form-control" maxlength="20" 
                    ...
                    <div class="form-group ">
                        ...
                        <input type="text" runat="server" id="SecondLastName" class="form-control" maxlength="20" placeholder="Segundo Apellido">
                    </div>
                    ...
                    <div class="form-group ">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1"
                            ...
                            InitialValue = "Seleccione un Genero"                    
                            runat="server">
                    ...
                    <div class="form-group">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5"
                            ...
                            ForeColor="Red"
                            validationgroup="GrupoEmpleado" 
                            InitialValue = "Seleccione un Nivel"                    
                            runat="server">
                        </asp:requiredfieldvalidator>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-md-6 col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" runat="server" id="JobMode" class="form-control" maxlength="20" 
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" runat="server" id="SalaryJob" class="form-control" placeholder="BsF." maxlength="8"
            ...
            <div class="row">
                <div class="col-xs-12 col-md-6 col-lg-6">
                    ...
                    <div class="form-group ">
                        ...
                        <input type="text" runat="server" id="CityAddress" class="form-control" maxlength="20" 
                    ...
                    <div class="form-group ">
                        ...
                        <input type="text" runat="server" id="AddresEspecific" class="form-control" maxlength="50" 
