<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/Master/Tangerine.Master" AutoEventWireup="true" CodeBehind="ActivarLead.aspx.cs" Inherits="Tangerine.GUI.M3.ActivarLead" %>
            ...
            <div class="col-md-6">
              ...
              <div class="box box-info">
                ...
                <form role="form" name="eliminar_lead" id="eliminar_lead" method="post"   runat="server">
                   <asp:Button id="btnaceptar" style="margin-top:5%" class="btn btn-primary" href="Listar.aspx" type="submit" runat="server" OnClick="Activar_Click" Text ="Activar"   ></asp:Button>
                </form>
                    </div>
