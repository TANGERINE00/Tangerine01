<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/Master/Tangerine.Master" AutoEventWireup="true" CodeBehind="Listar.aspx.cs" Inherits="Tangerine.GUI.M3.EjemploM3" %>
   ...
   <div class="col-xs-12">
     <div class="box">
       <div class="box-header">
           ...
           <th style="text-align:center;"><a class="btn btn-primary glyphicon glyphicon-search" href="ConsultarLead.aspx"></a><a  class="btn btn-default glyphicon glyphicon-pencil" href="ModificarLead.aspx"></a><a  class="btn btn-danger glyphicon glyphicon-trash" href="EliminarLead.aspx"></a><a class="btn btn-default glyphicon glyphicon-upload"></a></th> 
        </div><!-- /.box-header -->
