...
namespace DominioTangerine.Entidades.M10
{
  public   class EmpleadoM10:Entidad
  {
      ...
      public EmpleadoM10(string primerNombre, string segundoNombre, string primerApellido, string segundoApellido, 
      ...
      public EmpleadoM10(string pNombre, string sNombre, string pApellido, string sApellido,
      ...
      public EmpleadoM10(int empleadoId, string empPNombre, string empSNombre, string empPApellido, string empSApellido,
                       string empGenero, int empCedula, DateTime empFecha, string empActivo, string empEstudio,
